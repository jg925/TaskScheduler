...
public class Schedule {
	...
	static class MidnightSplitter {
		...
		// Method to assist displaying a schedule by the day. It breaks a Splittable at
		// midnight local time (using
		// the supplied zone, if necessary), breaking it repeatedly if the Splittable
		// spans more than one midnight.
