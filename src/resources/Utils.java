...
public class Utils {
	...
	/*
	 * public static List<Event> generateStandups(LocalDateTime start, int dayCount,
	 * Duration dur, ZoneId zone) {
	 * List<LocalDate> workingDays = generateWorkingDays(start.toLocalDate(),
	 * dayCount);
	...
	private static TemporalAdjuster nextWorkingDayAdjuster = t -> LocalDate.from(t).getDayOfWeek() == FRIDAY
