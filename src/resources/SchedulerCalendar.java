...
public class SchedulerCalendar {
  ...
  private boolean populatePeriods(List<WorkPeriod> periods, List<Task> tasks, LocalDateTime scheduleStart,
      ZoneId zoneId) {
  ...
  NavigableSet<WorkPeriod> overwritePeriodsWithEvents(ZoneId zone) {
    // TODO (maybe) save overwritePeriodsByEvents from having to consider periods
