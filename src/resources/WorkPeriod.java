...
public class WorkPeriod implements Comparable<WorkPeriod>, Splittable<WorkPeriod> {
    ...
    public String toString() {
        ...
        String workPeriodHeader = "\n\tWork Period: " + timeFormatter.format(startTime) + " to "
    ...
    // WorkPeriods may need to be split on two occasions: during scheduling, when
    // they are still empty
    // and can be split by Events; and during calendar display, when they have been
    // populated and may
